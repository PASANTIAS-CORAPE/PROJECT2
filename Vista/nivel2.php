...
<body>
    ...
    echo "<td>".'<form action="../Controlador/eliminarnivel2.php" method="post"><button value="eliminar'.$resultado['documento_categoria_id'].'" name="eliminar" id="Eliminar">Eliminar</button></form>'."</td>"; 
    echo "</tr>";
    ...
    <div id="popup" class="overlay">
            <div id="popupBody">
                ...
                <div class="popupContent">
                    <form action="../Controlador/agregarnivel2.php" method="POST" >
                        <table>
                            <tr>
                                <td>
        ...
        $cont=0;
         ...
         <div id="popup1" class="overlay">
                <div id="popupBody">
                    ...
                    <a id="cerrar" href="#">&times;</a>
                    <div class="popupContent">
                        <form action="../Controlador/editarnivel2.php" method="post">
