            ...
            <div id="tabladecomtenidos">
                <table border="1" id="regTable" name="tablainfo">
                    ...
                    while ($contador <= $numero) {
                        ...
                        echo "<td>" . '<form action="../Controlador/eliminar.php" method="post"><button value="eliminar' . $resultado['documento_categoria_id'] . '" name="eliminar" id="Eliminar">Eliminar</button></form>' . "</td>";
                        echo "</tr>";
                        $contador++;
                    } ?>
                    </thead>
